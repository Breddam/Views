SELECT
				...
				CAST(QL63600V_1.TEKST AS VARCHAR(75)) AS Admin_adressebeskyttelse,
...
FROM
				...
				QL63600V AS QL63600V_1 RIGHT OUTER JOIN
				JY64800V ON QL63600V_1.KODE = JY64800V.CBSKADRA ON QL65000V.KODE = JY64800V.CADM LEFT OUTER JOIN
				QL61000V ON JY64800V.CARTK = QL61000V.KODE LEFT OUTER JOIN
...
WHERE        (JY64800V.CARTK NOT IN (2, 3, 8, 9, 20, 32, 33, 38, 39, 40))