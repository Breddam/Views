SELECT
				...
				CAST(CAST(JY64900V.EKOMNR AS Varchar(3)) + CAST(JY64800V.VEJ_KODE AS Varchar(4)) + LTRIM(RTRIM(CAST(JY64800V.HUS_NUMMER AS Varchar(4)))) + LTRIM(RTRIM(REPLACE(JY64800V.ELEJNR, ' ', ''))) AS Varchar(14)) AS UDVADRESSEID,
