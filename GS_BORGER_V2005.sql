SELECT     
				...
				CAST(RTRIM(JY68000V.VEJ_NAVN + ' ' + REPLACE(LTRIM(REPLACE(RTRIM(JY64300V.HUS_NUMMER), '0', ' ')), ' ', '0') + ' ' + RTRIM(LTRIM(JY64300V.ETAGE)) + ' ' + RTRIM(LTRIM(JY64300V.SIDE_DORNR))) AS VARCHAR(50)) AS Adresse, 
				JY64400V.POSTNR, 
