SELECT     
				...
				udf_FormatPrintName(JY64300V.ADRESSERINGSNAVN) AS Navn, 
				JY64300V.ADRNAVN_DATO AS Dato_for_adresseringsnavn, 
				CAST(RTRIM(JY68000V.VEJNAVN + ' ' + REPLACE(LTRIM(REPLACE(RTRIM(JY64300V.HUS_NUMMER), '0', ' ')), ' ', '0') + ' ' + RTRIM(LTRIM(JY64300V.ETAGE)) + ' ' + RTRIM(LTRIM(JY64300V.SIDE_DORNR))) AS VARCHAR(50)) AS Adresse, 
				JY64400V.POSTNR, 
...
FROM         
        ...
        JY68000V ON JY64300V.VEJ_KODE = JY68000V.VEJ_KODE LEFT OUTER JOIN
        JY64400V ON JY64300V.PERSONNUMMER = JY64400V.KOMMUNENUMMER AND JY64300V.VEJ_KODE = JY64400V.VEJ_KODE LEFT OUTER JOIN
