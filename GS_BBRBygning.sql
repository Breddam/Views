SELECT     
				...
				JY70100V.ANTLEJUKOEKKEN AS Antal_lejligheder_uden_køkken, 
				...
				JY70100V.BYG_AFLOEB_TILL AS Afløbsforholdstilladelseskode, 
				QL20800V.TEKST AS Afløbsforholdstilladelse, 
				...
				JY70100V.SUPPYDERVAEGMAT AS Supplerende_ydervægsmateriale, 
				...
				JY70100V.TSSTORMPALAG AS Dato_for_pålæg_fra_Stormrådet, 
				JY70100V.BYGSKADEOMFATFORS AS Byggeskadeforsikringskode, 
				CAST(QL23200V.TEKST AS VarChar(50)) AS Omfattet_byggeskadeforsikring, 
				JY70100V.BYGSKADEFORSIK AS Byggeskadeforsik_selskabskode, 
				CAST(QL20700V.TEKST AS VarChar(26)) AS Byggeskadeforsikringsselskab, 
				JY70100V.TSBYGSKADE AS Dato_for_byggeskadeforsikring, 
