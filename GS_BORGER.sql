SELECT     
				...
				CONVERT(DATE,JY64300V.FODSEL_DATO) AS Fødselsdato, 
				CONVERT(INT, DATEDIFF(d, JY64300V.FODSEL_DATO, GETDATE()) / 365.25) AS Alder,
				JY64300V.KON AS Køn, 
				JY64300V.STILLING AS Stilling, 
				CONVERT(DATE,JY64300V.STILLING_DATO) AS Stillingsdato, 
				...
				CONVERT(DATE,JY64300V.ADRNAVN_DATO) AS Dato_for_adresseringsnavn, 
				...
				CONVERT(DATE,JY64300V.BORGERSTATUS_TS) AS Tidsstempling_borgerstatus, 
				JY64300V.ANTAL_BORN AS Antal_børn, 
				CONVERT(DATE,JY64300V.ADR_TILFLYT_TS) AS Tidsstempling_tilflytning, 
				...
				CONVERT(DATE,JY64300V.ADR_FRAFLYT_TS) AS Tidsstempling_fraflytning, 
				JY64300V.CO_NAVN AS CO_Navn, 
				CONVERT(DATE,JY64300V.KOM_TILFLYTDATO) AS Kommune_tilflytningsdato, 
				JY64300V.FRAFLYT_KOMMUNENR AS Fraflytningskommunenummer, 
				QL60000V.TEKST As Fraflytningskommune, 
				CONVERT(DATE,JY64300V.ADRESSEBESKYT_DATO) AS Dato_for_adressebeskyttelse, 
				CONVERT(DATE,JY64300V.ADR_BESKYT_SLTDATO) AS Dato_sletning_adressebeskyt, 
				CONVERT(DATE,JY64300V.CIVILSTAND_TS) AS Tid_for_civilstand, 
				CAST(QL58800V.TEKST AS VARCHAR(75)) AS Civilstand, 
				CONVERT(DATE,JY64300V.CIVILST_OPHOR_TS) AS Tid_for_civilstandsophør, 
				...
				CONVERT(DATE,JY64300V.STATSB_RET_TS) AS Tid_for_ændr_statsborgerskab, 
				CONVERT(DATE,JY64300V.STATBORG_OPHOR_TS) AS Tid_for_ophør_statsborgersk, 
...
FROM         
				...
				QL60000V ON JY64300V.FRAFLYT_KOMMUNENR = QL60000V.KODE LEFT OUTER JOIN
