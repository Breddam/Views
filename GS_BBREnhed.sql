SELECT 
				...
				JY70400V.TSDISPTIDS AS Dato_for_tidsbegr_dispensatio, 
				...
				JY70400V.AABENOVERDAEKAREAL AS Samlet_areal_af_åbne_overdækn, 
				JY70400V.LUKOVERDAEKAREAL AS Samlet_areal_af_lukkede_overd, 
				...
				CAST(JY72100V.KOMMUNENUMMER AS varchar(3)) + CAST(JY72100V.VEJ_KODE AS varchar(4)) + RTRIM(JY72100V.HUS_NUMMER) + LTRIM(JY72100V.ETAGE) + LTRIM(JY72100V.SIDE_DOERNR) AS UDVadresseID, 
				JY70400V.ENH_ID, 
				JY70400V.EAD_ID, 
				JY70400V.ETA_ID, 
				JY70400V.OPG_ID, 
