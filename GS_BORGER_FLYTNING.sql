SELECT
				...
				CASE
					WHEN LEN(CONVERT(VARCHAR,AA70100V.PERSONNUMMER))=10
					THEN CAST(LEFT(CONVERT(VARCHAR,AA70100V.PERSONNUMMER),6)+'-'+RIGHT(CONVERT(VARCHAR,AA70100V.PERSONNUMMER),4) AS VARCHAR(11))
					ELSE CAST('0'+LEFT(CONVERT(VARCHAR,AA70100V.PERSONNUMMER),5)+'-'+RIGHT(CONVERT(VARCHAR,AA70100V.PERSONNUMMER),4) AS VARCHAR(11))
				END AS CPR,
